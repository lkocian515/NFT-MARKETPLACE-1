...
export default function CreateItem() {
    ...
    const [formInput, updateFormInput] = useState({price: '', name: '', decription: ''})
...
async function createItem() {
    ...
    async function createSale() {
        ...
        let contract = new ethers.Contract(nftmarketaddress, NFT.abi, signer)
